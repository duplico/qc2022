...
#define ANIM_COUNT 3
#define ANIM_COUNT_INCL_META 13
#define ANIM_H00 0
#define ANIM_H01 1
#define ANIM_H02 2
#define ANIM_META_CONNECTS 3
#define ANIM_META_NEWPAIR 4
#define ANIM_META_NEWUBER 5
#define ANIM_META_PAIR 6
#define ANIM_META_PAIRUBER 7
#define ANIM_META_STARTUP_FADE 8
#define ANIM_META_STARTUP_SPIN 9
#define ANIM_META_Z_BRIGHTNESS0 10
#define ANIM_META_Z_BRIGHTNESS1 11
#define ANIM_META_Z_BRIGHTNESS2 12
#define ANIM_TYPE_SOLID 0
#define ANIM_TYPE_FASTTWINKLE 1
#define ANIM_TYPE_SLOWTWINKLE 2
extern const leds_animation_t *all_anims[13];
#endif // _H_
