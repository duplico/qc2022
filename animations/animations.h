...
extern const rgbcolor_t meta_startup_frames[][5];
extern const uint16_t meta_startup_durations[];
extern const uint16_t meta_startup_fade_durs[];
extern const leds_animation_t meta_startup;
...
#define ANIM_COUNT 3
#define ANIM_COUNT_INCL_META 10
#define ANIM_H00 0
#define ANIM_H01 1
#define ANIM_H02 2
...
#define ANIM_META_STARTUP 6
#define ANIM_META_Z_BRIGHTNESS0 7
#define ANIM_META_Z_BRIGHTNESS1 8
#define ANIM_META_Z_BRIGHTNESS2 9
#define ANIM_TYPE_SOLID 0
#define ANIM_TYPE_FASTTWINKLE 1
extern const leds_animation_t *all_anims[10];
#endif // _H_
