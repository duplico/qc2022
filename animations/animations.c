...
const uint16_t b01_durations[] = {400, 400, 400, 400, 400};
const uint16_t b01_fade_durs[] = {200, 200, 200, 200, 200};
// the animation:
const leds_animation_t b01 = {b01_frames, b01_durations, b01_fade_durs, 5, ANIM_TYPE_SOLID};
...
const uint16_t b02_durations[] = {400, 400, 400, 400, 400};
const uint16_t b02_fade_durs[] = {200, 200, 200, 200, 200};
// the animation:
const leds_animation_t b02 = {b02_frames, b02_durations, b02_fade_durs, 5, ANIM_TYPE_SOLID};
...
const uint16_t b03_durations[] = {400, 400, 400, 400};
const uint16_t b03_fade_durs[] = {200, 200, 200, 200};
// the animation:
const leds_animation_t b03 = {b03_frames, b03_durations, b03_fade_durs, 4, ANIM_TYPE_SOLID};
...
const uint16_t b04_durations[] = {400, 400, 400, 400, 400};
const uint16_t b04_fade_durs[] = {200, 200, 200, 200, 200};
// the animation:
const leds_animation_t b04 = {b04_frames, b04_durations, b04_fade_durs, 5, ANIM_TYPE_SOLID};
...
const uint16_t b05_durations[] = {400, 400, 400, 400, 400};
const uint16_t b05_fade_durs[] = {200, 200, 200, 200, 200};
// the animation:
const leds_animation_t b05 = {b05_frames, b05_durations, b05_fade_durs, 5, ANIM_TYPE_SOLID};
...
const uint16_t b06_durations[] = {400, 400, 400, 400, 400};
const uint16_t b06_fade_durs[] = {200, 200, 200, 200, 200};
// the animation:
const leds_animation_t b06 = {b06_frames, b06_durations, b06_fade_durs, 5, ANIM_TYPE_SOLID};
...
const rgbcolor_t h01_frames[][5] = {
    {{0x0, 0x0, 0x0}, {0x0, 0x0, 0xff}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0xff, 0x0, 0x0}},
    {{0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0xff}, {0xff, 0x0, 0x0}, {0x0, 0x0, 0x0}},
    {{0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0xff, 0x0, 0x0}, {0x0, 0x0, 0xff}, {0x0, 0x0, 0x0}},
    {{0x0, 0x0, 0x0}, {0xff, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0xff}},
    {{0xff, 0x0, 0xff}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}},
};
const uint16_t h01_durations[] = {150, 150, 150, 150, 150};
const uint16_t h01_fade_durs[] = {50, 50, 50, 50, 50};
// the animation:
...
const uint16_t h02_durations[] = {400, 400};
const uint16_t h02_fade_durs[] = {400, 400};
// the animation:
const leds_animation_t h02 = {h02_frames, h02_durations, h02_fade_durs, 2, ANIM_TYPE_SOLID};
...
const uint16_t h03_durations[] = {400, 400, 400, 400};
const uint16_t h03_fade_durs[] = {200, 200, 200, 200};
// the animation:
const leds_animation_t h03 = {h03_frames, h03_durations, h03_fade_durs, 4, ANIM_TYPE_SOLID};
...
const uint16_t h05_durations[] = {100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100};
const uint16_t h05_fade_durs[] = {50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50};
// the animation:
const leds_animation_t h05 = {h05_frames, h05_durations, h05_fade_durs, 15, ANIM_TYPE_SOLID};
...
const uint16_t h06_durations[] = {500, 500, 500, 500, 500};
const uint16_t h06_fade_durs[] = {100, 100, 100, 100, 100};
// the animation:
...
const uint16_t h10_durations[] = {400};
const uint16_t h10_fade_durs[] = {200};
// the animation:
const leds_animation_t h10 = {h10_frames, h10_durations, h10_fade_durs, 1, ANIM_TYPE_SLOWTWINKLE};
...
// the animation:
const leds_animation_t s00 = {s00_frames, s00_durations, s00_fade_durs, 5, ANIM_TYPE_FASTTWINKLE};
...
// the animation:
const leds_animation_t s01 = {s01_frames, s01_durations, s01_fade_durs, 5, ANIM_TYPE_FASTTWINKLE};
...
const uint16_t u00_durations[] = {400, 400, 400, 400, 400};
const uint16_t u00_fade_durs[] = {200, 200, 200, 200, 200};
// the animation:
const leds_animation_t u00 = {u00_frames, u00_durations, u00_fade_durs, 5, ANIM_TYPE_SOLID};
...
const uint16_t u01_durations[] = {400, 400, 400, 400, 400};
const uint16_t u01_fade_durs[] = {200, 200, 200, 200, 200};
// the animation:
const leds_animation_t u01 = {u01_frames, u01_durations, u01_fade_durs, 5, ANIM_TYPE_SOLID};

///////////////// U02:
const rgbcolor_t u02_frames[][5] = {
    {{0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0xff, 0x0, 0x0}},
    {{0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0xff, 0x0, 0x0}, {0x0, 0x0, 0x0}},
    {{0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0xff, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}},
    {{0x0, 0x0, 0x0}, {0xff, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}},
...
const uint16_t u02_durations[] = {400, 400, 400, 400, 400};
const uint16_t u02_fade_durs[] = {200, 200, 200, 200, 200};
// the animation:
const leds_animation_t u02 = {u02_frames, u02_durations, u02_fade_durs, 5, ANIM_TYPE_SOLID};

const leds_animation_t *all_anims[34] = {&b00, &b01, &b02, &b03, &b04, &b05, &b06, &h00, &h01, &h02, &h03, &h04, &h05, &h06, &h07, &h08, &h09, &h10, &s00, &s01, &s02, &u00, &u01, &u02, &meta_connects, &meta_newpair, &meta_newuber, &meta_pair, &meta_pairuber, &meta_startup_fade, &meta_startup_spin, &meta_z_brightness0, &meta_z_brightness1, &meta_z_brightness2};
