...
const uint16_t h02_durations[] = {250, 250};
const uint16_t h02_fade_durs[] = {300, 300};
// the animation:
...
const rgbcolor_t h09_frames[][5] = {
    ...
    {{0x0, 0x80, 0x0}, {0x0, 0x80, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}},
    {{0x0, 0x80, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}},
    {{0x80, 0x0, 0x80}, {0x80, 0x0, 0x80}, {0x80, 0x0, 0x80}, {0x80, 0x0, 0x80}, {0x80, 0x0, 0x80}},
};
const uint16_t h09_durations[] = {200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 400};
const uint16_t h09_fade_durs[] = {200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 600, 200};
// the animation:
const leds_animation_t h09 = {h09_frames, h09_durations, h09_fade_durs, 13, ANIM_TYPE_SOLID};

///////////////// H10:
const rgbcolor_t h10_frames[][5] = {
    {{0xf0, 0x14, 0x3c}, {0xf0, 0x14, 0x3c}, {0xf0, 0x14, 0x3c}, {0xf0, 0x14, 0x3c}, {0xf0, 0x14, 0x3c}},
    {{0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}},
    {{0x0, 0xbf, 0xff}, {0x0, 0xbf, 0xff}, {0x0, 0xbf, 0xff}, {0x0, 0xbf, 0xff}, {0x0, 0xbf, 0xff}},
    {{0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}},
};
const uint16_t h10_durations[] = {1000, 200, 1000, 200};
const uint16_t h10_fade_durs[] = {200, 200, 200, 200};
// the animation:
const leds_animation_t h10 = {h10_frames, h10_durations, h10_fade_durs, 4, ANIM_TYPE_SLOWTWINKLE};
...
const uint16_t h11_durations[] = {150, 150, 150, 150, 150, 150};
const uint16_t h11_fade_durs[] = {10, 10, 10, 10, 10, 10};
// the animation:
const leds_animation_t h11 = {h11_frames, h11_durations, h11_fade_durs, 6, ANIM_TYPE_SOLID};
...
const uint16_t h12_durations[] = {400, 400, 400, 400, 400};
const uint16_t h12_fade_durs[] = {200, 200, 200, 200, 200};
// the animation:
const leds_animation_t h12 = {h12_frames, h12_durations, h12_fade_durs, 5, ANIM_TYPE_FASTTWINKLE};
...
const uint16_t u01_durations[] = {250, 250, 250, 250, 250, 250};
const uint16_t u01_fade_durs[] = {200, 200, 200, 200, 200, 200};
// the animation:
const leds_animation_t u01 = {u01_frames, u01_durations, u01_fade_durs, 6, ANIM_TYPE_SOLID};

const leds_animation_t *all_anims[35] = {&b00, &b01, &b02, &b03, &b04, &b05, &b06, &h00, &h01, &h02, &h03, &h04, &h05, &h06, &h07, &h08, &h09, &h10, &h11, &h12, &s00, &s01, &s02, &u00, &u01, &meta_connects, &meta_newpair, &meta_newuber, &meta_pair, &meta_pairuber, &meta_startup_fade, &meta_startup_spin, &meta_z_brightness0, &meta_z_brightness1, &meta_z_brightness2};
